<template>
  <div class="page" style="color: white">
    <header>
      <div>
        <ul class="header">
          <li><button class="c-button c-button-normal " v-tap="{methods:$root.routeTo, to:'page-trading'}">BITARK </button></li>
          <li><button class="c-button c-button-normal " >DEX</button></li>
        </ul>
      </div>
    </header>
      ...
      <div class="inner">
        <section class="coin_tab">
          <ul >
            ...
            <li :class="[active==='tab-container2'?'activation':'']" @click="whickTabFun('tab-container2')"><span>WETH</span></li>
            <li></li>
            <li></li>
          </ul>
        </section>
                ...
                <div class="item">
                  <div class="inner">
                    <ul class="item">
                      ...
                      <li>
                        <button class="c-button c-button-normal c-button-green">+0.0%</button>
                      </li>
                    </ul>

                    <ul class="item">
                      <li>
                        <h1 ><span>TKY</span>/<i>WETH</i></h1>
                        <h2>24H 38756</h2>
                      </li>
                      <li>
                        <h1>0.000685</h1>
                      ...
                      <li>
                        <button class="c-button c-button-normal c-button-green">+4.5%</button>
                      </li>
                    </ul>
...
<script>
  ...
  import PageWalletGather from "./wallet_gather";
  Vue.component(TabContainer.name, TabContainer);
  Vue.component(TabContainerItem.name, TabContainerItem);

  export default {
    name:'page-trading_dex',
    data(){
      return {
        scroll:false,
        scrolltwo:false,
...
<style lang="less" scoped>
  ...
  .coin_tab{
    ul{
      ...
      li.activation{
        ...
        color: #4d7bf3;
        border-bottom: .02rem solid #4d7bf3;
      }
      li{
        position: relative;
        bottom: -0.02rem;
    ...
    ul{
      ...
      li{
        ...
        i.down{
          ...
          width: 0.14rem;
          height: 0.17rem;
          background: url('../assets/img/fall@3x.png') no-repeat center;
  ...
  .h_icon{
    ...
    height: .23rem;
    left: 0.3rem;
    background: url('../assets/img/BITARK.png') no-repeat center;
    background-size: contain;
    display: inline-block;
  }
  .reg-account {
  ...
  .login-form {
    ...
    p {
      ...
      i {
        ...
        height: 0.5rem;
        right: 0;
        background: url('../assets/img/reset-password@3x.png') no-repeat center;
        background-size: contain;
